...
<section class="stats">
@foreach(['Users'=>$users,'Recognitions'=>$recognitions,'Today'=>$today,'This month'=>$month,'Low confidence'=>$low,'Failed AI'=>$failed,'Open feedback'=>$feedback,'Training'=>$trainingCandidates] as $label=>$value)
